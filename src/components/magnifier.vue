...
　　　　var x = this.pageX - $('.middle_img')[0].offsetParent.offsetLeft - $('.middle_img')[0].offsetParent.clientLeft;
　　　　//用页面y - 父盒子的offsetTop - 父盒子的上边框宽度
　　　　var y = this.pageY - $('.middle_img')[0].offsetParent.offsetTop - $('.middle_img')[0].offsetParent.clientTop;
