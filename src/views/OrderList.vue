            ...
            <ul class="cart-item-list">
              <li v-for="(item,index) in orderList" :key="index">
                <div class="cart-tab-3">
                  <div class="item-price-total"  >{{index+1}}</div>
                </div>
                 <div class="cart-tab-3">
                  <div class="item-price-total"   >{{item.createDate}}</div>
                </div>
                <div class="cart-tab-3">
                  <div class="item-price-total">{{item.orderId}}</div>
                </div>
                <div class="cart-tab-3">
                  <div class="item-price-total">{{item.orderTotal|currency('￥')}}</div>
                </div>
                <div class="cart-tab-3">
                  <div
                ...
                <div class="cart-tab-3">
                  <div class="cart-item-opration">
                    <!-- <a :style="{width:'10px',marginTop:'20px'}" href="javascript:;" class="item-edit-btn" @click="delOrderConfirm(item)">
        ...
        <div class="order-create-main">
          <div class="order-create-btn-wrap">
            <div class="btn-l-wrap">
              <router-link  to="/cart"> <a-button size='large'>返回我的购物车</a-button></router-link>
            </div>
            <div class="btn-r-wrap">
              <router-link  to="/"><a-button size='large'>返回商品列表</a-button></router-link>
            </div>
          </div>
        </div>
      </div>
...
export default {
  ...
  aginOrder(order) {
      ...
      axios
        .post("/api/users/aginOrder", { orderId, orderTotal: order.orderTotal })
        .then(response => {
   ...
   pay(order) {
    ...
    //       this.goodsList = this.order.goodsList;
    ...
    // pay(orderId, orderTotal, orderStatus) {
    //   if (orderStatus == "1") {
    //     return;
    //   }
    //   axios
